...
export class PharmacistComponent {
 //shows the PerfectScrollbar
  ...
  // A method showDiv is declared which checks if the length of results array is less than 1 and returns true, else returns false in order to show an error message inside a div 
  showDiv(){
